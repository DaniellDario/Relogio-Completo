...
const relogio = setInterval(function () {
    ...
    const mesesAbreviados = ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Out', 'Nov', 'Dec'];
    const diasAbreviados = ['Sun', 'Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat'];

    year.textContent = y;
    month.textContent = mesesAbreviados[m - 1]; // Subtrai 1 para obter o índice correto no array.
    day.textContent = diasAbreviados[dateToday.getDay()];
    horas.textContent = h;
